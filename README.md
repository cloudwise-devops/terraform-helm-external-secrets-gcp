...
| <a name="input_external_secrets_poller_internal"></a> [external\_secrets\_poller\_internal](#input\_external\_secrets\_poller\_internal) | The amount of time before the values reading again from the SecretStore provider | `string` | `"1h"` | no |
